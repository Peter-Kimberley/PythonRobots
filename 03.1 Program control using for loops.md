...
for day in ['Monday,','Tuesday,', 'Wednesday,', 'Thursday,', 'Friday,', 'Saturday,', 'Sunday,']:
    counter = counter + 1
    print(day,"is day number", counter)
...
<style>#notebook-container { width:50%; float:left !important;}</style>
    ...
    new error message: TypeError: Cannot read properties of null (reading 'setAttribute')
...
```
    ...
    0 % 4 gives remainder 0
    1 % 4 gives remainder 1
    2 % 4 gives remainder 2
    3 % 4 gives remainder 3
    4 % 4 gives remainder 0
    5 % 4 gives remainder 1
    6 % 4 gives remainder 2
    7 % 4 gives remainder 3
...
*I don't think that the robot will complete a full square in this instance as it will only be doing the loop up to but not including 3 times.*
...
for day in ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday']:
    if day == 'Wednesday':
        print("I can't go shopping this afternoon as its",day)
        continue
    print("I can go shopping this afternoon as its",day)
...
```
    ...
    I can go shopping this afternoon as its Monday
    I can go shopping this afternoon as its Tuesday
    I can't go shopping this afternoon as its Wednesday
    I can go shopping this afternoon as its Thursday
    I can go shopping this afternoon as its Friday
    I can go shopping this afternoon as its Saturday
    I can go shopping this afternoon as its Sunday
